...
class newReportTask(newJob):
    ...
    def newModel(self, app_id, cur_time):
        ...
        self.reduceAndInsert(app_id, v_day, player_dict, user_dict, device_dict)
    ...
    # 合并插入数据
    def reduceAndInsert(app_id, v_day, player_dict, user_dict, device_dict):
        table = 'r_newly'
        sc_keys = list(
